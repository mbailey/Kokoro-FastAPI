...
from kokoro_fastapi.routers.debug import router as debug_router
from kokoro_fastapi.routers.development import router as dev_router
from kokoro_fastapi.routers.openai_compatible import router as openai_router
from kokoro_fastapi.routers.web_player import router as web_router
...
async def lifespan(app: FastAPI):
    ...
    from kokoro_fastapi.services.temp_manager import cleanup_temp_files
